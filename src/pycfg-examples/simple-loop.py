...
__py_cfg_squares = {0:__py_cfg_internal_function_main,1:__py_cfg_internal_function_introduce_yourself,2:__py_cfg_internal_function_refuse_to_talk,5:__py_cfg_internal_function_count_the_years,9:__py_cfg_internal_function_wait_till_youre_older}
